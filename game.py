...
class Game:
    ...
    def __init__(self):      
        ...
        self.screen = pygame.display.set_mode((1600, 1080))
        pygame.display.set_caption("Pygamon - Aventure")

        # charger la carte (tmx)
        tmx_data = pytmx.util_pygame.load_pygame("C:\\Users\\passi\\OneDrive\\Bibliothèque\\Programmation\\Projets python\\Pygamon\\carte.tmx")
    ...
    def switch_house(self):
        # charger la carte (tmx)
        tmx_data = pytmx.util_pygame.load_pygame("C:\\Users\\passi\\OneDrive\\Bibliothèque\\Programmation\\Projets python\\Pygamon\\house.tmx")
        map_data = pyscroll.data.TiledMapData(tmx_data)
        map_layer = pyscroll.orthographic.BufferedRenderer(map_data, self.screen.get_size())
        map_layer.zoom = 2
